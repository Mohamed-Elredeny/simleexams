                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="course-meta-style">
                                <li class="author">
                                    <div class="image">
                                        <img src="{{asset('assets/site/images/teachers/2.jpg')}}" width="60"  alt="">
                                    </div>
                                ...
                                <div class="tab-btm">
                                    ...
                                    <div class="tabs-wrapper">
                                        <ul class="nav classic-tabs tabs-cyan" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link waves-light active" data-toggle="tab" href="#curriculum" role="tab">Lessons</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link waves-light " data-toggle="tab" href="#panel51" role="tab">Description</a>
                                            </li>
                                ...
                                <div class="tab-content card">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                                        <div class="card-body">
                                                            ...
                                                            <center>
                                                                <button class="btn" style="background:#ff3115;color: #fff">View Details</button>
                                                            </center>
                                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="instructors" role="tabpanel">
                                        <div class="instructor-list">
                                            <div class="image">
                                                <img src="{{asset('assets/site/images/teachers/2.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                        ...
                                        <div class="instructor-list pt-45">
                                            <div class="image">
                                                <img src="{{asset('assets/site/images/teachers/9.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                        ...
                                        <div class="instructor-list pt-45">
                                            <div class="image">
                                                <img src="{{asset('assets/site/images/teachers/6.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                    ...
                                    <div class="tab-pane fade" id="review" role="tabpanel">
                                        ...
                                        <div class="instructor-list">
                                            <div class="image">
                                                <img src="{{asset('assets/site/images/teachers/8.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                                <div class="client-rating">
                                                    <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i>
                                        ...
                                        <div class="instructor-list mt-15">
                                            <div class="image">
                                                <img src="{{asset('assets/site/images/teachers/7.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                                <div class="client-rating">
                                                    <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i>
                                        ...
                                        <div class="instructor-list mt-15">
                                            <div class="image">
                                                <img src="{{asset('assets/site/images/teachers/4.jpg')}}" width="150"  alt="">
                                            </div>
                                            <div class="author-name">
                                                <div class="client-rating">
                                                    <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="sidebar-area">
                        ...
                        <div class="cate-box">
                            ...
                            <ul>
                                <li>
                                    <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="#">Learning Lessons<span>(05)</span></a>
                                </li>
                                <li>
                                    <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="#">Video Reviews Lessons <span>(07)</span></a>
                                </li>
                                <li>
                                    <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="#">Engineering Tech Lessons <span>(09)</span></a>
                                </li>
                                <li>
                                    <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="#"> Righteous Indignation Lessons<span>(08)</span></a>
                                </li>
                                <li>
                                    <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="#">General Education Lessons<span>(04)</span></a>
                                </li>
                            </ul>
                        </div>

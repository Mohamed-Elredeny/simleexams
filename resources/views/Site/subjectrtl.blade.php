                ...
                <div class="col-lg-4 col-md-12 text-right">
                    <div class="sidebar-area">
                        ...
                        <div class="cate-box">
                            ...
                            <ul>
                                <li>
                                    <i class="fa fa-angle-left" aria-hidden="true"></i> <a href="#">Learning Lessons<span>(05)</span></a>
                                </li>
                                <li>
                                    <i class="fa fa-angle-left" aria-hidden="true"></i> <a href="#">Video Reviews Lessons <span>(07)</span></a>
                                </li>
                                <li>
                                    <i class="fa fa-angle-left" aria-hidden="true"></i> <a href="#">Engineering Tech Lessons <span>(09)</span></a>
                                </li>
                                <li>
                                    <i class="fa fa-angle-left" aria-hidden="true"></i> <a href="#"> Righteous Indignation Lessons<span>(08)</span></a>
                                </li>
                                <li>
                                    <i class="fa fa-angle-left" aria-hidden="true"></i> <a href="#">General Education Lessons<span>(04)</span></a>
                                </li>
                            </ul>
                        </div>

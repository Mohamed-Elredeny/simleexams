...
<div class="rs-courses-details pt-100 pb-70 text-right" dir="rtl">
    <div class="container">
        <div class="row mb-30">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="sidebar-area">
                    ...
                    <div class="cate-box">
                        ...
                        <ul>
                            <li>
                                <i class="fa fa-angle-left" aria-hidden="true"></i> <a href="courses-details2.html">Images <span>(2)</span></a>
                            </li>
                            <li>
                                <i class="fa fa-angle-left" aria-hidden="true"></i> <a  href="courses-details2.html">Videos<span>(7)</span></a>
                            </li>
                            <li>
                                <i class="fa fa-angle-left" aria-hidden="true"></i> <a  href="courses-details2.html">Files<span>(9)</span></a>
                            </li>
                            <li>
                                <i class="fa fa-angle-left" aria-hidden="true"></i> <a  href="courses-details2.html"> Exams<span>(8)</span></a>
                            </li>
                            <li>
                                <i class="fa fa-angle-left" aria-hidden="true"></i> <a  href="courses-details2.html">Questions<span>(4)</span></a>
                            </li>
                        </ul>
                    </div>

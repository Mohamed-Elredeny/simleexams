            ...
            <div class="row mb-50 blog-inner">
                <div class="col-lg-6 col-md-12">
                    <div class="blog-images">
                        <a href="{{ route('blog.details', ['id' => $blog->id]) }}"><i class="fa fa-link" aria-hidden="true"></i> <img src="{{ asset('assets/images/blogs/' . $blog->image) }}" style="height: 300px !important;" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="blog-content">
                        ...
                        <h4><a href="{{ route('blog.details', ['id' => $blog->id]) }}">{{ $blog->title_en }}</a></h4>
                        <ul class="blog-meta">
        ...
        <div class="row mb-50 blog-inner">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="blog-content">
                    ...
                    <h4><a href="{{ route('blog.details', ['id' => $blog->id]) }}">{{ $blog->title_ar }}</a></h4>
                    <ul class="blog-meta">
                        <li class="time"><a href="#"><i class="fa fa-user-o"></i> {{ $blog->buplisher }}</a></li>
                    </ul>
                    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
                    ...
                    <script>
                        ...
                        document.getElementById('dev'+{{$blog->id}}).innerHTML= "<p>" + divs[0].textContent + "</p><a class='primary-btn' href='{{ route('blog.details', ['id' => $blog->id]) }}'>المزيد</a>";
                        divs[0].classList.remove("desciptionn");
                    </script>

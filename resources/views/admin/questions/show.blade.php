        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <h5 class="mb-5 mt-3">عرض تفاصيل السوال</h5>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="number" id="example-text-input" name="number" required value="{{$question->number}}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label"> محتوي السوال </label>
                            <div class="col-sm-10">
                                <textarea class="form-control" type="text" id="example-text-input" name="body" required disabled>{{$question->body}}</textarea>
                            </div>
                        </div>
                        <?php
                        ...
                        @for($i=0;$i<count($answersss);$i++)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" id="example-text-input" name="questions{{$i}}" value="{{$answersss[$i]}}" required disabled>
                                </div>
                                @if($i == $question->right_answer)
                                    <div class="col-sm-2">
                                        <input class="form-control" type="radio" id="example-text-input" name="answers" required value="{{$i}}" checked disabled>
                                    </div>
                                @else
                                    <div class="col-sm-2">
                                        <input class="form-control" type="radio" id="example-text-input" name="answers" required value="{{$i}}" disabled>
                                    </div>
                                @endif
                            </div>
                        @endfor
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                @if($question->question_bank == 1)
                                    <input type="checkbox" id="switch10" switch="dark" checked name="question_bank" disabled />
                                    <label for="switch10" data-on-label="نعم" data-off-label="لا"></label>
                                @else
                                    <input type="checkbox" id="switch10" switch="dark"  name="question_bank" disabled />
                                    <label for="switch10" data-on-label="نعم" data-off-label="لا"></label>
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                @if($question->hint_id)
                                    <input type="checkbox" id="switch11" switch="dark" checked name="is_there_hints" disabled />
                                    <label for="switch11" data-on-label="نعم" data-off-label="لا"></label>
                                @else
                                    <input type="checkbox" id="switch11" switch="dark"  name="is_there_hints" disabled />
                                    <label for="switch11" data-on-label="نعم" data-off-label="لا"></label>
                                @endif
                            </div>
                        </div>
                        @if($question->hint_id)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="example-text-input" name="hint_details" value="{{$question->hint->description}}" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">المرفقات</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="file" id="example-text-input" name="hint_media_id" disabled>

                                            ...
                                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <a class="btn btn-dark col-sm-12"  href="{{route('admin.students.edit',['student'=>$admin->id])}}">تعديل</a>
                                                        <form method="post" action="{{route('admin.students.destroy',['student'=>$admin->id])}}">
                                                            @csrf
                                                            @method('DELETE')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="{{asset('assets/images/students/'.$admin->media->file)}}" alt="" style="height:400px;width:400px">
                </div>
